...
public class TestSkatteProcenter {
	...
	public void testKommuneSkat() {
		SkatteProcenter sp = new SkatteProcenter(null, new BigDecimal(24.9), new BigDecimal(1.23), null, null, null);
	...
	public void testKommuneSkat2() {
		SkatteProcenter sp = new SkatteProcenter(null, new BigDecimal(23.9), new BigDecimal(1.23), null, null, null);
	...
	public void testAmtSkat2() {
		SkatteProcenter sp = new SkatteProcenter(null, new BigDecimal(23.9), new BigDecimal(2.23), null, null, null);
	...
	public void testKirkeSkat() {
		SkatteProcenter sp = new SkatteProcenter(null, new BigDecimal(23.9), new BigDecimal(1.23), new BigDecimal(0.2), null, null);
	...
	public void testKirkeSkat2() {
		SkatteProcenter sp = new SkatteProcenter(null, new BigDecimal(23.9), new BigDecimal(1.23), new BigDecimal(0.1), null, null);
	...
	public void testSundhedsBidragSkat() {
		SkatteProcenter sp = new SkatteProcenter(null, new BigDecimal(23.9), new BigDecimal(1.23), new BigDecimal(0.1), new BigDecimal(1.00), null);
	...
	public void testSundhedsBidragSkat2() {
		SkatteProcenter sp = new SkatteProcenter(null, new BigDecimal(23.9), new BigDecimal(1.23), new BigDecimal(0.1), new BigDecimal(1.02), null);
	...
	public void testBundSkat() {
		SkatteProcenter sp = new SkatteProcenter(null, new BigDecimal(23.9), new BigDecimal(1.23), new BigDecimal(0.1), new BigDecimal(1.02), new BigDecimal(9.08));
	...
	public void testBundSkat2() {
		SkatteProcenter sp = new SkatteProcenter(null, new BigDecimal(23.9), new BigDecimal(1.23), new BigDecimal(0.1), new BigDecimal(1.02), new BigDecimal(9.06));
	...
	public void testKommuneNavn() {
		SkatteProcenter sp = new SkatteProcenter("Herning", new BigDecimal(23.9), new BigDecimal(1.23), new BigDecimal(0.1), new BigDecimal(1.02), new BigDecimal(9.06));
